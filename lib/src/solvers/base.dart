...
abstract class Base {
  ...
  Path to_path(PathOptions options/*={}*/) {
    ...
    LinkType how;
    (_solution != null ? _solution : current_solution())!
        .forEach((Position? pt) {
  ...
  Iterable<Position?> current_solution() {
    throw UnimplementedError(
        "solver subclasses must implement 'current_solution'");
  }
  ...
  //# algorithm-dependent.
  Position? step() {
    throw UnimplementedError("solver subclasses must implement 'step'");
  }
}
